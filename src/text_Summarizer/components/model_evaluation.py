...
class ModelEvaluation:
    ...
    def calculate_metric_on_test_ds(self, dataset, metric, model, tokenizer, 
        ...
        for article_batch, target_batch in tqdm(
            ...
            ''' length_penalty ensures that the model does not generate overly long sequences. '''
            
            # Decode the generated texts, replace tokens, and add the decoded texts with the references to the metric.
